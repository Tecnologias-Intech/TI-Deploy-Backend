...
class GithubCLIOperator {
    constructor({ branch, version, deployPat, botToken, tiApi }) {
        this.branch = '';
        this.version = '';
        this.versionBranch = '';
        this.owner = '';
    ...
    newBranch() {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            yield ((_a = this.tiApi) === null || _a === void 0 ? void 0 : _a.updateDeployment({ status: backend_deployment_status_enum_1.BackendDeploymentStatus.SETTING_VERSION }));
            try {
    ...
    setVersion() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield promises_1.default.writeFile('.version', this.version, 'utf8');
            }
            catch (e) {
    ...
    pushChanges() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield exec.exec('git', ['add', '.version']);
    ...
    generatePR() {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            yield ((_a = this.tiApi) === null || _a === void 0 ? void 0 : _a.updateDeployment({ status: backend_deployment_status_enum_1.BackendDeploymentStatus.GENERATE_PR }));
            try {
    ...
    approvePR() {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            yield ((_a = this.tiApi) === null || _a === void 0 ? void 0 : _a.updateDeployment({ status: backend_deployment_status_enum_1.BackendDeploymentStatus.APPROVE_PR }));
            try {
    ...
    mergePR() {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            yield ((_a = this.tiApi) === null || _a === void 0 ? void 0 : _a.updateDeployment({ status: backend_deployment_status_enum_1.BackendDeploymentStatus.MERGE_PR }));
            try {
    ...
    tagAndRelease() {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b;
            yield ((_a = this.tiApi) === null || _a === void 0 ? void 0 : _a.updateDeployment({ status: backend_deployment_status_enum_1.BackendDeploymentStatus.GENERATE_RELEASE_N_TAG }));
