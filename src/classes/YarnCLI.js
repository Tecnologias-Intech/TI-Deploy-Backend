...
class YarnCLI {
    ...
    install() {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            yield ((_a = this.tiApi) === null || _a === void 0 ? void 0 : _a.updateDeployment({ status: backend_deployment_status_enum_1.BackendDeploymentStatus.INSTALLING_DEPS }));
            try {
                this.notification.info('Installing dependencies...');
                yield exec.exec('yarn', ['install'], { cwd: 'functions' });
            }
            catch (e) {
    ...
    build() {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            yield ((_a = this.tiApi) === null || _a === void 0 ? void 0 : _a.updateDeployment({ status: backend_deployment_status_enum_1.BackendDeploymentStatus.BUILD_APP }));
            try {
                if (this.environment) {
                    this.notification.info('Configuring environment.ts file');
                    yield fs.writeFile('functions/src/environment.ts', this.environment);
                    this.notification.success('functions/src/environment.ts file configured');
                }
                this.notification.info('Building application');
                yield exec.exec('yarn', ['run', 'build'], { cwd: 'functions' });
